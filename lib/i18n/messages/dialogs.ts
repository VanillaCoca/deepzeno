...
export const dialogsMessages: LocaleMessages = {
  en: {
    ...
    "dialog.login.inviteOnly": "Invite only",
    "dialog.login.inviteSubtitle":
      "ZENO is invite-only for now. Enter your invite code to continue.",
    "dialog.login.inviteLabel": "Invite code",
    "dialog.login.invitePlaceholder": "Enter invite code",
    "dialog.login.inviteUnlock": "Unlock",
    "dialog.login.inviteVerified": "Invite verified",
    "dialog.login.inviteInvalid": "That invite code isn't valid.",
    "dialog.login.asideTagline": "Conversation, distilled into judgment.",
  ...
  zh: {
    ...
    "dialog.login.inviteOnly": "邀请制",
    "dialog.login.inviteSubtitle": "ZENO 目前为邀请制。输入邀请码后即可登录。",
    "dialog.login.inviteLabel": "邀请码",
    "dialog.login.invitePlaceholder": "输入邀请码",
    "dialog.login.inviteUnlock": "解锁",
    "dialog.login.inviteVerified": "邀请码已验证",
    "dialog.login.inviteInvalid": "邀请码不正确。",
    "dialog.login.asideTagline": "把对话，凝成判断。",
  ...
  fr: {
    ...
    "dialog.login.inviteOnly": "Sur invitation",
    "dialog.login.inviteSubtitle":
      "ZENO est sur invitation pour l'instant. Entrez votre code d'invitation pour continuer.",
    "dialog.login.inviteLabel": "Code d'invitation",
    "dialog.login.invitePlaceholder": "Entrez le code d'invitation",
    "dialog.login.inviteUnlock": "Déverrouiller",
    "dialog.login.inviteVerified": "Code validé",
    "dialog.login.inviteInvalid": "Code d'invitation invalide.",
    "dialog.login.asideTagline": "La conversation, distillée en jugement.",
